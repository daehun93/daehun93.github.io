...
data-config="{'skin':'skins/simpleBlack/skin.css','volume':50,'autoplay':true,'shuffle':false,'repeat':0,'placement':'bottom','showplaylist':false,'playlist':[{'title':'TEST','url':'https://www.youtube.com/watch?v=uCOMvwyHQdE'}]}" ></script>
